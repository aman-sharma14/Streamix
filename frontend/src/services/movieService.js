...
// Gateway URL
const API_URL = `${process.env.REACT_APP_API_BASE_URL}/movie`;
...
const movieService = {
    ...
    searchTVShows: async (query) => {
        const token = localStorage.getItem('token') || sessionStorage.getItem('token');
        const response = await axios.get(`${process.env.REACT_APP_API_BASE_URL}/tv/search?query=${query}`, {
    ...
    getAllTVShows: async () => {
        const token = localStorage.getItem('token') || sessionStorage.getItem('token');
        const response = await axios.get(`${process.env.REACT_APP_API_BASE_URL}/tv/all`, {
            headers: { Authorization: `Bearer ${token}` }
        });
        return response.data;
    },
    ...
    getPopularTVShows: async () => {
        const token = localStorage.getItem('token') || sessionStorage.getItem('token');
        const response = await axios.get(`${process.env.REACT_APP_API_BASE_URL}/tv/popular`, {
            headers: { Authorization: `Bearer ${token}` }
        });
        return response.data;
    },
    ...
    getTopRatedTVShows: async () => {
        const token = localStorage.getItem('token') || sessionStorage.getItem('token');
        const response = await axios.get(`${process.env.REACT_APP_API_BASE_URL}/tv/top-rated`, {
            headers: { Authorization: `Bearer ${token}` }
        });
        return response.data;
    },
    ...
    getTrendingTVShows: async () => {
        const token = localStorage.getItem('token') || sessionStorage.getItem('token');
        const response = await axios.get(`${process.env.REACT_APP_API_BASE_URL}/tv/trending`, {
            headers: { Authorization: `Bearer ${token}` }
        });
        return response.data;
    },
    ...
    getTVShowById: async (id) => {
        const token = localStorage.getItem('token') || sessionStorage.getItem('token');
        const response = await axios.get(`${process.env.REACT_APP_API_BASE_URL}/tv/${id}`, {
            headers: { Authorization: `Bearer ${token}` }
        });
        return response.data;
    },
    ...
    getTVShowCast: async (tmdbId) => {
        const token = localStorage.getItem('token') || sessionStorage.getItem('token');
        const response = await axios.get(`${process.env.REACT_APP_API_BASE_URL}/tv/tmdb/${tmdbId}/cast`, {
            headers: { Authorization: `Bearer ${token}` }
        });
        return response.data;
    },
    ...
    getSimilarTVShows: async (tmdbId) => {
        const token = localStorage.getItem('token') || sessionStorage.getItem('token');
        const response = await axios.get(`${process.env.REACT_APP_API_BASE_URL}/tv/tmdb/${tmdbId}/similar`, {
            headers: { Authorization: `Bearer ${token}` }
        });
        return response.data;
    },
    ...
    getTVShowDetailsFromProxy: async (tmdbId) => {
        const token = localStorage.getItem('token') || sessionStorage.getItem('token');
        const response = await axios.get(`${process.env.REACT_APP_API_BASE_URL}/tv/tmdb/${tmdbId}`, {
            headers: { Authorization: `Bearer ${token}` }
        });
        return response.data;
    },
    ...
    getTVShowSeasonDetails: async (tmdbId, seasonNumber) => {
        const token = localStorage.getItem('token') || sessionStorage.getItem('token');
        const response = await axios.get(`${process.env.REACT_APP_API_BASE_URL}/tv/tmdb/${tmdbId}/season/${seasonNumber}`, {
            headers: { Authorization: `Bearer ${token}` }
        });
        return response.data;
    },
